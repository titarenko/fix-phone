...
var fixRuPhone = fixPhoneBuilder(9, 13, true, '+7', /^\+7(\d{3})/,
	[].concat(
		_.range(900, 906 + 1), _.range(908, 934 + 1), _.range(936, 939 + 1), 941, _.range(950, 956 + 1), 958, _.range(960, 971 + 1), _.range(977, 978 + 1), _.range(980, 989 + 1), _.range(991, 997 + 1), 999,
		...
		_.range(811, 818 + 1), _.range(820, 821 + 1), 831, _.range(833, 836 + 1), _.range(841, 848 + 1), 851, 855, _.range(861, 863 + 1), _.range(865, 867 + 1), 869, _.range(871, 873 + 1), _.range(877, 879 + 1)
	)
);
